...
const NAV_ITEMS = [
  ...
  { label: 'Surveys',   href: '/dashboard/surveys',   icon: 'assignment'   },
  { label: 'Responses', href: '/dashboard/responses', icon: 'rate_review'  },
  { label: 'Templates', href: '/dashboard/templates', icon: 'description'  },
  ...
  return (
    <aside className='flex h-screen w-56 flex-col border-r bg-background'>
      <div className='flex h-16 items-center border-b px-4'>
        <img src='/assets/tiuquin_logo.png' alt='Tiuquin' className='h-8 w-auto object-contain' />
      </div>
