import { STATUS_CFG, completionOf, fmtDate } from "../common/shared"
...
export default function SurveyListItem({ survey, template, active, onClick }: { survey: SiteSurvey; template: Template | null | undefined; active: boolean; onClick: () => void }) {
  const pct = completionOf(template, survey.responses as Record<string, QuestionValue> | undefined)
